...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls:
        ...
        total += num
        num_rolls-= 1
    return total if not is_sow_sad else 1
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    play_one,play_two = player_score % 10,(opponent_score // 10) % 10
    if play_one == play_two:
        return 1
    else:
        return 3 * abs(play_one - play_two)
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    last_max_score,now_score = 0,0
    max_state = 10
    for i in range(1,11):
        averaged_dice = make_averaged(roll_dice,samples_count)
        now_score = averaged_dice(i,dice)
        if now_score > last_max_score:
            max_state = i
            last_max_score = now_score
    return max_state
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    score_before = score
    if sus_update(0,score,opponent_score) - score_before >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
